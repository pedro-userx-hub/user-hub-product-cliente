...
const mockStudies: TeamStudy[] = [
  ...
  {
    id: "s-pesquisa-rascunho-atrasado",
    teamId: "t-pesquisa",
    name: "Usabilidade — app mobile (datas vencidas)",
    status: "Rascunho",
    owners: ["Ana Silva"],
    ...
    format: STUDY_METHOD_LABELS.individual,
    objective:
      "Validar a nova navegação do app mobile com usuários da base — rascunho pronto para lançar, com período de sessões já vencido.",
    ownerId: "u-ana",
    contactChannel: "email",
    contactValue: "ana@empresa.com",
    cxOwnerId: "",
    ...
    sessionFormat: "remote",
    remotePlatform: "meet",
    remoteLink: "https://meet.google.com/rascunho-atrasado",
    scheduleSlots: [
      { id: "slot-ra-1", weekday: "mon", startTime: "09:00", endTime: "12:00" },
      { id: "slot-ra-2", weekday: "wed", startTime: "14:00", endTime: "18:00" },
    ],
    participantType: "b2c",
    participantQuantity: 12,
    desiredProfile:
      "Pessoas de 25–40 anos que usam o app ao menos 1× por semana.",
